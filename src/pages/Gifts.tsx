...
const Gifts = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-xl font-semibold text-foreground">Gift Tracker</h1>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className={cn("text-xl font-semibold", config.color)}>{count}</span>
              </div>
                  ...
                  return (
                    ...
                    >
                      <div className={cn(
                        ...
                        isCompleted ? 'bg-nice' : 'bg-muted'
                      )} />
                      <span className="text-[9px] text-muted-foreground hidden sm:block">{step.slice(0, 4)}</span>
                    </div>
                  );
                })}
              </div>
